...
public class DaoUnidade {
    ...
    public static void inserir(Unidade unidade)
        ...
        String sql = "INSERT INTO unidade (nome, endereco, cidade, estado, "
                + "email, telefone1, telefone2, cadastradoPor, cadastradoEm, enabled) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            preparedStatement.setString(8, unidade.getCadastradoPor());
    ...
    public static void atualizar(Unidade unidade)
        ...
        String sql = "UPDATE unidade SET nome=?, endereco=?, cidade=?, estado=?,"
                + " email=?, telefone1=?, telefone2=?, cadastradoPor=?, cadastradoEm=? WHERE (unidade.id=?)";
        ...
        try {
            ...
            preparedStatement.setString(8, unidade.getCadastradoPor());
            preparedStatement.setTimestamp(9, new Timestamp(System.currentTimeMillis()));
            preparedStatement.setInt(10, unidade.getId());
    ...
    public static LinkedList<Unidade> procurar(String nomeUnidade)
        ...
        try {
            ...
            while (result.next()) {
                ...
                unidade.setCadastradoPor(result.getString("cadastradoPor"));                
                unidade.setCadastradoEm(new Date(result.getTimestamp("cadastradoEm").getTime()));
