...
<html>
    <head>
        ...
        <title>Manutenção de Cadastro de Unidades</title>
        ...
        <div class="container">
            <div class="row row-offcanvas row-offcanvas-right">
                <div class="col-xs-12 col-sm-9">
                    ...
                    <div class="jumbotron">
                        <h1>Manutenção de Cadastro de Unidades</h1>
                    </div>

                    <div class="jumbotron">
                        <form data-toggle="validator" action="${pageContext.request.contextPath}/unidade_buscar" method="get">
                            <input type="hidden" name="action" value="unidade_buscar">
                            <div class="input-group">
                                <input type="text" name="nome" class="form-control" placeholder="Digite aqui o nome da unidade" required>
                                <span class="input-group-btn">
                                    <button class="btn btn-primary" type="submit">Buscar</button>
                                    <a class="btn btn-success" href="${pageContext.request.contextPath}/unidade_listar">Listar</a>
                                </span>
                            </div><!-- /input-group -->
                        </form>
                    </div>
                    ...
                    <c:if test="${not empty unidades}">   
                        <h2 class="sub-header">Unidades</h2>
                                ...
                                <tbody>
                                    <c:forEach items="${unidades}" var="unidade">                                
                                        <tr>
                                            ...
                                            <td><c:out value="${unidade.estado}" /></td>
                                            <td><c:out value="${unidade.cadastradoPor}" /></td>                                            
                                            <td><fmt:formatDate pattern = "dd/MM/yyyy HH:mm:ss" value = "${unidade.cadastradoEm}" /></td>
                                            <td>
