                        ...
                        <div class="row">
                            <form data-toggle="validator"  action="${pageContext.request.contextPath}/curso_atualizar" method="post">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="nome" class="form-control" placeholder="Nome" maxlength="255" value="<c:out value="${curso.nome}" />" required>
                                </div>

                                <div class="form-group col-md-12">
                                    <label for="descrição" class="col-form-label">Descrição: </label>
                                    <textarea rows="3" name="descricao" class="form-control" placeholder="Descrição" maxlength="255" value="<c:out value="${curso.descricao}" />"></textarea>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-control" name="categoria" required>
                                            <option value="<c:out value="${curso.categoria}" />"><c:out value="${curso.categoria}" /></option>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="valor" class="form-control" placeholder="1234,00" maxlength="8" value="<c:out value="${curso.valor}" />" required>
                                        </div>
                                    </div>
                                </div>
